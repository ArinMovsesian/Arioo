        ...
        <div className="form-container">
          <form className="account-form">
            <div className="inputs-container">
              <div className="field">
              <h3><bold>Last Seen Privacy</bold></h3>
              </div>
              <div className="field">
                <RadioGroup onChange={this.onChange} value={this.state.value}>
                  <Radio style={radioStyle} value={1}>Everybody</Radio>
                  <Radio style={radioStyle} value={2}>My contacts</Radio>
                  <Radio style={radioStyle} value={3}>Nobody</Radio>
                </RadioGroup>
                <p htmlFor="profileName">Who can see your last seen time</p>
              </div>


              <span className="field" style={{color:"#BBBBBB",fontSize:"10px",display:"inline"}}>
                importantL you won't be abale to see seen times for people with whom you don't share
                your last seen time.approximate last seen will be showninsted (recently, within a week,
                within a month)
              </span>
              ...
              <span className="field" style={{ color: '#BBBBBB', fontSize: '10px', display: 'inline' }}>
                There seetings will override the values above
              </span>
